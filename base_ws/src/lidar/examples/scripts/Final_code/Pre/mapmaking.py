...
class GPS2UTM:
    def __init__(self):
        ...
        rospy.Subscriber("/start_lidar", Bool, self.detect_for_parking)
        ...
        self.tofar = rospy.Publisher('/tofar', Bool, queue_size=10)
        self.toclose = rospy.Publisher('/toclose', Bool, queue_size=10)
        ...
        self.sxcv = -1
        self.beforestate = -1
        self.is_detect_for_parking = True

    def detect_for_parking(self,data):
        self.is_detect_for_parking = data.data
    ...
    def lidar_callback(self, _data):
        if not self.is_detect_for_parking:
            return
