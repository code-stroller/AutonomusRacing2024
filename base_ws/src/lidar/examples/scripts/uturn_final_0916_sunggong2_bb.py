...
class GPS2UTM:
    ...
    def lidar_callback(self, _data):
        ...
        self.publish_obstacles([[point_0[1]*self.resolution-1,(point_0[0]-int(self.look_up_L/self.resolution))*self.resolution]], self.middle_point_pub, color=(1.0, 1.0, 0.0))
        
        uturn_cone = [[point_0[1]*self.resolution-1,(point_0[0]-int(self.look_up_L/self.resolution))*self.resolution]]
