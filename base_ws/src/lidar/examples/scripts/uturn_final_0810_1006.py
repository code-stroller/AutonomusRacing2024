...
class GPS2UTM:
    ...
    def should_add_cone(self, cones_list, new_cone, min_distance):
        ...
        if len(cones_list)<2:
            ...
            v1angle = [cones_list[-2][0] - cones_list[-3][0],cones_list[-2][1] - cones_list[-3][1]]
            v2angle = [cones_list[-1][0] - cones_list[-2][0],cones_list[-1][1] - cones_list[-2][1]]
            ...
            return N1 and v2angle +10 < v1angle
