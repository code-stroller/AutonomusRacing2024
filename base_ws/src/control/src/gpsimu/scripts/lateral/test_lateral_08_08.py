...
# ==========================================================================================
    ...
    def calc_pure_pursuit(self):    # pure_pursuit 계산 값을 이용하며 경로 생성
        ...
        Lp_x = self.current_position.x + self.vehicle_length * np.cos(self.vehicle_yaw) + Lp * np.cos(self.vehicle_yaw)
        Lp_y = self.current_position.y + self.vehicle_length * np.sin(self.vehicle_yaw) + Lp * np.sin(self.vehicle_yaw)
