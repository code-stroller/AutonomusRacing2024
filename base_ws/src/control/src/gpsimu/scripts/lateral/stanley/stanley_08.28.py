...
# ==========================================================================================
    ...
    # ==================== local_path 불러오기 ================================
        ...
        if min_index + 25 < len(ref_x):
            delta_east = ref_x[min_index + 25] - ref_x[min_index]
            delta_north = ref_y[min_index + 25] - ref_y[min_index]
        ...
        if curr_velocity_kmh != 0:
            steering = 1.5*pi_t + 0.5*np.arctan(k_s * x_t / curr_velocity_kmh)
