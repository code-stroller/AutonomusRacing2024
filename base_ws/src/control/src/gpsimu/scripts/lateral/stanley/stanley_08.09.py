...
# ==========================================================================================
    ...
    def calc_stanley(self):
        ...
        if len(ref_x) >= 9:
            ...
            delta_east =  ref_x[min_index] - front_utm_x
            delta_north = ref_y[min_index] - front_utm_y
        ...
        if curr_velocity_kmh != 0:
            steering = 0.9 * pi_t + 1*np.arctan(k_s * x_t / curr_velocity_kmh)
            print("pi_t:",math.degrees(0.9*pi_t), "x_t", math.degrees(1.1*np.arctan(k_s * x_t / curr_velocity_kmh)))
    ...
    def cal_control(self):
        ...
        # velocity for steer =================================================================
        if (abs(steering)<math.radians(7.)):
